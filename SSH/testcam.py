...
from utils.test_cam_utils import _get_image_blob, _compute_scaling_factor, visusalize_detections
...
def detect(net, im, thresh=0.05, visualize=False, timers=None, pyramid=False, visualization_folder=None):
    """
    ...
    if visualize:
        ...
        plt_name = "void"
        res_img, num_of_objs = visusalize_detections(im, cls_dets)
    timers['misc'].toc()
    return cls_dets, timers, res_img
